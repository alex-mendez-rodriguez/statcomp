...
- Bits of cool topics in data science & machine learning
...
- Use your favorite AI (e.g. ChatGPT, Gemini, etc) on the browser

- Use your favorite editor. Visual Studio Code is nice
